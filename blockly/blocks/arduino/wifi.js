...
Blockly.Blocks['wifi_connection'] = {
  /**
  ...
  onchange: function(event) {
    ...
    var name = this.getFieldValue('SSID_NAME');
     var pass = this.getFieldValue('SSID_PASS');
    if(name && pass && (name.length < 8 || pass.length < 0)){
