...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "czytaj pin analogowy pin#";
Blockly.Msg.ARD_ANALOGREAD_TIP = "Zwraca wartość pomiędzy 0 a 1024";
Blockly.Msg.ARD_ANALOGWRITE = "ustaw analogowy pin#";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Ustaw wartość analogową pomiędzy 0 a 255 dla określonego portu PWM"
Blockly.Msg.ARD_BUILTIN_LED = "ustaw wbudowaną diodę LED";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Włącza albo wyłącza wbudowaną w płytkę diodę LED";
...
Blockly.Msg.ARD_DEFINE = "Definiuj"
Blockly.Msg.ARD_DIGITALREAD = "czytaj pin# cyfrowy";
Blockly.Msg.ARD_DIGITALREAD_TIP = "Czytaj pin cyfrowy, którego wartość może wynosić: HIGH albo LOW";
Blockly.Msg.ARD_DIGITALWRITE = "ustaw pin# cyfrowy";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Write digital value HIGH or LOW to a specific Port";  // untranslated
Blockly.Msg.ARD_FUN_RUN_LOOP = "Funkcja loop. Pętla nieskończona:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "Funkcja setup. Uruchamiana na początku:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Defines the Arduino setup() and loop() functions.";  // untranslated
Blockly.Msg.ARD_HIGH = "WYSOKI";
Blockly.Msg.ARD_HIGHLOW_TIP = "Ustaw stan logiczny pinu na Wysoki lub Niski";
Blockly.Msg.ARD_LOW = "NISKI";
Blockly.Msg.ARD_MAP = "Mapuj"
...
Blockly.Msg.ARD_SERIAL_PRINT = "drukuj";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "dodaj nową linię";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "Drukuje dane na konsole/serial jako czytelny dla człowieka tekst";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "Blok Setup muis być dodany dla  %1 aby użyć tego bloku!"
Blockly.Msg.ARD_SERIAL_SETUP = "Setup";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Ustaw szybkość dla określonego Serial";
Blockly.Msg.ARD_SERIAL_SPEED = ":  prędkość do";
Blockly.Msg.ARD_SOFTWARE_SERIAL= 'Bluetooth';
Blockly.Msg.ARD_SOFTWARE_SERIAL_SETUP = 'Bluetooth Setup';
Blockly.Msg.ARD_SOFTWARE_SERIAL_SETUP_TIP = 'Ustaw piny wejścia i wyjścia (rx i tx)';
Blockly.Msg.ARD_SOFTWARE_SERIAL_PRINT = 'Bluetooth drukuj';
Blockly.Msg.ARD_SOFTWARE_SERIAL_PRINT_TIP = 'Bluetooth drukowanie';
Blockly.Msg.ARD_SOFTWARE_SERIAL_READ = 'Czytaj następny znak';
Blockly.Msg.ARD_SOFTWARE_SERIAL_READ_TIP = 'Czyta następny znak jeśli jest dostępny';
Blockly.Msg.ARD_SOFTWARE_SERIAL_AVAILABLE = 'następny znak jest dostępny?';
Blockly.Msg.ARD_SOFTWARE_SERIAL_AVAILABLE_TIP = 'Sprawdza czy następny znak jest już przysłany. Zwraca zmienną logiczną';
Blockly.Msg.ARD_SOFTWARE_SERIAL_WARN = "Blok Bluetooth Setup musi być dodany dla  %1 aby użyć tego bloku!";
Blockly.Msg.ARD_SERVO_READ = "czytaj kąt Serwa z PINu#";
Blockly.Msg.ARD_SERVO_READ_TIP = "Czyta kont ustawienia Serwa";
Blockly.Msg.ARD_SERVO_WRITE = "ustaw Serwo z pinu";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "Stopnie (0~180)";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Ustaw wartość kąta serwa w stopniach";
Blockly.Msg.ARD_SERVO_WRITE_TO = "do";
...
Blockly.Msg.ARD_TIME_DELAY = "czekaj";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "microseconds";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Czekaj przez określony czas w milisekundach"
Blockly.Msg.ARD_TIME_DELAY_TIP = "Czekaj przez określoną ilość milisekund";
...
Blockly.Msg.ARD_TIME_MS = "millisekundy";
Blockly.Msg.ARD_TONEFREQ = "przy częstotliwości";
Blockly.Msg.ARD_TONE_FREQ = "częstotliwość";  // untranslated
...
Blockly.Msg.ARD_TONE_WARNING = "Częstotliwość musi mieć zakres 31 - 65535";  // untranslated
Blockly.Msg.ARD_TYPE_ARRAY = "Tablica";
Blockly.Msg.ARD_TYPE_BOOL = "Zmienna Logiczna";
Blockly.Msg.ARD_TYPE_CHAR = "Znak";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";  // untranslated
Blockly.Msg.ARD_TYPE_DECIMAL = "Liczba z przecinkiem dziesiętnym";
Blockly.Msg.ARD_TYPE_LONG = "Duży Liczba";
Blockly.Msg.ARD_TYPE_NULL = "Null";
Blockly.Msg.ARD_TYPE_NUMBER = "Liczba";
Blockly.Msg.ARD_TYPE_SHORT = "Liczba Typu Short";
Blockly.Msg.ARD_TYPE_TEXT = "Tekst";
Blockly.Msg.ARD_TYPE_UNDEF = "Niezdefiniowane";
Blockly.Msg.ARD_ULTRASONIC_READ = "Czujnik Utradźwiękowy. Czytaj odległość"
Blockly.Msg.ARD_ULTRASONIC_READ_TIP = "Odczytuje odległość w centymetrach";
Blockly.Msg.ARD_VAR_AS = "jako";
Blockly.Msg.ARD_VAR_AS_TIP = "Ustaw wartość jako określony typ zmiennej";
Blockly.Msg.ARD_WIFI_SERVER_SSID =  "ustaw nazwę sieci";
Blockly.Msg.ARD_WIFI_SERVER_PASSWORD = "ustaw hasło wpa";
Blockly.Msg.ARD_WIFI_SERVER_WARNING = "hasło i nazwa SISD musi mieć co najmniej 8 liter",
Blockly.Msg.ARD_WRITE_TO = "do";
Blockly.Msg.NEW_INSTANCE = "Nowa instancja ...";
Blockly.Msg.NEW_INSTANCE_TITLE = "Nazwa nowej instancji:";
Blockly.Msg.RENAME_INSTANCE = "Zmień nazwę nowej instancji ...";  
Blockly.Msg.RENAME_INSTANCE_TITLE = "Zmień nazwy wszystkich '%1' instancji na:";
