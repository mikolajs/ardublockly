...
Blockly.Msg.ARD_SOFTWARE_SERIAL= 'Bluetooth';
Blockly.Msg.ARD_SOFTWARE_SERIAL_SETUP = 'Bluetooth Setup';
Blockly.Msg.ARD_SOFTWARE_SERIAL_SETUP_TIP = 'Set output and input pins';
Blockly.Msg.ARD_SOFTWARE_SERIAL_PRINT = 'Bluetooth print';
Blockly.Msg.ARD_SOFTWARE_SERIAL_PRINT_TIP = 'Bluetooth print';
Blockly.Msg.ARD_SOFTWARE_SERIAL_READ = 'Read character';
Blockly.Msg.ARD_SOFTWARE_SERIAL_READ_TIP = 'Read next character if available';
Blockly.Msg.ARD_SOFTWARE_SERIAL_AVAILABLE = 'available?';
Blockly.Msg.ARD_SOFTWARE_SERIAL_AVAILABLE_TIP = 'Check if has next character in stream. Returns boolean';
Blockly.Msg.ARD_SOFTWARE_SERIAL_WARN = "Block Bluetooth Setup must be added for %1, if you wanted use this blocks";
